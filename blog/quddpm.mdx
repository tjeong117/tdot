...
where $J_{ijkl} \sim \mathcal{N}(0, J^2)$. This is the Sachdev-Ye-Kitaev model, which saturates the chaos bound and has direct connections to holographic duality. Time evolution is computed via matrix exponential:
